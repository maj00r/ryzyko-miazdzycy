...
const findGrid = (age: number, gender: string, isSmoking: boolean) => {
  // each 2D array is asigned to age range 
  const closestAge = closestValue(uniqueAges, age)
  
  const matchedProbabilityGrid = ensure(propabilityTable.tables.find(x => 
                                    x.age === closestAge
                                &&  x.gender === gender
                                &&  x.isSmoking === isSmoking))
...
const pressureAndCholesterolMapper = (pressureValue : number, 
                                      cholesterolType : string, 
  ...
  switch (closestMmolValue) {
    case 4 : computedX = 0; break;
    case 5 : computedX = 1; break;
    case 6 : computedX = 2; break;
    case 7 : computedX = 3; break;
    case 8 : computedX = 4; break;
  }
  const closestPressureValue = closestValue(uniquePressures, pressureValue)
  switch (closestPressureValue) {
    case 180 : computedY = 0; break;
    case 160 : computedY = 1; break;
    case 140 : computedY = 2; break;
    case 120 : computedY = 3; break;
  }
